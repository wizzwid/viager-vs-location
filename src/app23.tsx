...
/* ===============================
   Viager helpers + component (abbreviated in interest of space)
==================================*/
        ...
        <Section title="Paramètres – Crédit">
          <div className="space-y-3">
            ...
            <label className="flex items-center gap-2 select-none cursor-pointer">
              ...
              <span className="text-sm">Assurance calculée chaque mois sur le capital restant dû <span title="Si décoché : assurance 'normale' calculée sur capital initial (mensuelle constante)." className="inline-flex items-center justify-center w-4 h-4 rounded-full bg-gray-200 text-gray-700 text-[10px] ml-1">?</span></span>
            </label>
          </div>
        </Section>
...
export default function App() {
  ...
  const [tab, setTab] = useLocalStore<string>("app:activeTab", urlInit.tab || "Location nue");
  ...
  const webAppJsonLd = {
    ...
    "name":"Simulateur Immobilier Complet – app23",
    "url": location?.href || "",
  ...
  return (
    <HelmetProvider>
      <Helmet>
        <title>Simulateur Immobilier Complet – app23</title>
        <meta name="description" content="Viager, Location nue, SCPI, Local commercial, Crédit immobilier avec assurance CRD (option). Sauvegarde auto & lien partageable." />
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-6xl mx-auto p-6 space-y-6 print-max-w">
          <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 no-print">
            <div>
              <h1 className="text-2xl font-bold">Simulateur Immobilier – app23</h1>
              <p className="text-sm text-gray-500">Sauvegarde auto • Lien partageable (masqué) • Aides "?"</p>
            </div>
